...
if (deger==">"){
 ...
 digitalWrite(trigPin2, LOW); 
  ...
  //Serial.println(" cm");
    ...
    if(mesafe2==45){Serial.print("-");}
    if(mesafe2==46){Serial.print("_");}
    if(mesafe2==47){Serial.print("*");}
    if(mesafe2==48){Serial.print("?");}
    if(mesafe2==49){Serial.print("~");}
    if(mesafe2==50){Serial.print("|");}
    if(mesafe2==51){Serial.print("}");}
    if(mesafe2==52){Serial.print("]");}
    if(mesafe2==53){Serial.print(")");}
    if(mesafe2==54){Serial.print("[");}
    if(mesafe2==55){Serial.print("{");}   
    if(mesafe2==56){Serial.print("(");}
    if(mesafe2==57){Serial.print("@");}
    if(mesafe2==58){Serial.print("#");}
    if(mesafe2==59){Serial.print("$");}
    if(mesafe2==60){Serial.print("&");}
    if(mesafe2>=61){Serial.print("<");}
...
analogWrite(2,200);     //DC MOTOR HIZLARI
analogWrite(7,200);
analogWrite(13,200);
analogWrite(8,200);
                        //----------------1.MOTOR SÜRÜCÜ
